...
public class ATOConfiguredFeature {
	...
	public static final ImmutableList<OreConfiguration.TargetBlockState> ORE_IRIDIUM_TARGET_LIST = ImmutableList.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, BlockList.IRIDIUM_ORE.get().defaultBlockState()), OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, BlockList.IRIDIUM_SLATE_ORE.get().defaultBlockState()), OreConfiguration.target(OreFeatures.NETHERRACK,BlockList.IRIDIUM_NETHER_ORE.get().defaultBlockState()),OreConfiguration.target(new BlockMatchTest(Blocks.END_STONE),BlockList.IRIDIUM_END_ORE.get().defaultBlockState()),OreConfiguration.target(new TagMatchTest(ItemTagRegistry.ANCIENT_STONE), BlockList.OTHER_IRIDIUM_ORE.get().defaultBlockState()));
