...
public class ATOConfiguredFeature {
	...
	public static Feature<NoFeatureConfig> ALUMINUM = registerFeature("aluminum_ore",new OreVein(NoFeatureConfig.CODEC,BlockList.ALUMINUM.ORE.get(),BlockList.ALUMINUM.SLATE_ORE.get()));
	...
	public static Feature<NoFeatureConfig> URANIUM = registerFeature("uranium_ore", new OreVein(NoFeatureConfig.CODEC,BlockList.URANIUM.ORE.get(),BlockList.URANIUM.SLATE_ORE.get()));
	public static ConfiguredFeature<?, ?> ORE_URANIUM = newConfiguredFeature("uranium_ore", URANIUM.configured(IFeatureConfig.NONE));
	public static Feature<NoFeatureConfig> TIN = registerFeature("tin_ore", new OreVein(NoFeatureConfig.CODEC,BlockList.TIN.ORE.get(),BlockList.TIN.SLATE_ORE.get()));
	public static ConfiguredFeature<?, ?> ORE_TIN = newConfiguredFeature("tin_ore", TIN.configured(IFeatureConfig.NONE));
	public static Feature<NoFeatureConfig> SILVER = registerFeature("silver_ore", new OreVein(NoFeatureConfig.CODEC,BlockList.SILVER.ORE.get(),BlockList.SILVER.SLATE_ORE.get()));
	public static ConfiguredFeature<?, ?> ORE_SILVER = newConfiguredFeature("silver_ore", SILVER.configured(IFeatureConfig.NONE));
	public static Feature<NoFeatureConfig> LEAD = registerFeature("lead_ore", new OreVein(NoFeatureConfig.CODEC,BlockList.LEAD.ORE.get(),BlockList.LEAD.SLATE_ORE.get()));
	public static ConfiguredFeature<?, ?> ORE_LEAD = newConfiguredFeature("lead_ore", LEAD.configured(IFeatureConfig.NONE));
	public static Feature<NoFeatureConfig> ZINC = registerFeature("zinc_ore", new OreVein(NoFeatureConfig.CODEC,BlockList.ZINC.ORE.get(),BlockList.ZINC.SLATE_ORE.get()));
	public static ConfiguredFeature<?, ?> ORE_ZINC = newConfiguredFeature("zinc_ore", ZINC.configured(IFeatureConfig.NONE));
	public static Feature<NoFeatureConfig> NICKEL = registerFeature("nickel_ore", new OreVein(NoFeatureConfig.CODEC,BlockList.NICKEL.ORE.get(),BlockList.NICKEL.SLATE_ORE.get()));
	public static ConfiguredFeature<?, ?> ORE_NICKEL = newConfiguredFeature("nickel_ore", NICKEL.configured(IFeatureConfig.NONE));
	public static Feature<NoFeatureConfig> PLATINUM = registerFeature("platinum_ore", new OreVein(NoFeatureConfig.CODEC,BlockList.PLATINUM.ORE.get(),BlockList.PLATINUM.SLATE_ORE.get()));
	public static ConfiguredFeature<?, ?> ORE_PLATINUM = newConfiguredFeature("platinum_ore", PLATINUM.configured(IFeatureConfig.NONE));
	public static Feature<NoFeatureConfig> OSMIUM = registerFeature("osmium_ore", new OreVein(NoFeatureConfig.CODEC,BlockList.OSMIUM.ORE.get(),BlockList.OSMIUM.SLATE_ORE.get()));
	...
	public static ConfiguredFeature<?, ?> ORE_OTHER_ALUMINUM = newConfiguredFeature("ore_other_aluminum",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.ALUMINUM.OTHER_ORE.get().defaultBlockState(), Configuration.aluminum_SpawnSize * 2))
	...
	public static ConfiguredFeature<?, ?> ORE_OTHER_URANIUM = newConfiguredFeature("ore_other_uranium",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.URANIUM.OTHER_ORE.get().defaultBlockState(), Configuration.uranium_SpawnSize * 2))
					.decorated(Placement.DEPTH_AVERAGE.configured(
	...
	/*public static ConfiguredFeature<?, ?> ORE_OTHER_COPPER = newConfiguredFeature("ore_other_copper",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.COPPER.OTHER_ORE.get().defaultBlockState(), Configuration.copper_SpawnSize * 2))
					.decorated(Placement.DEPTH_AVERAGE.configured(
...
*/
	public static ConfiguredFeature<?, ?> ORE_OTHER_TIN = newConfiguredFeature("ore_other_tin",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.TIN.OTHER_ORE.get().defaultBlockState(), Configuration.tin_SpawnSize * 2))
					.decorated(Placement.DEPTH_AVERAGE.configured(
	...
	public static ConfiguredFeature<?, ?> ORE_OTHER_SILVER = newConfiguredFeature("ore_other_silver",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.SILVER.OTHER_ORE.get().defaultBlockState(), Configuration.silver_SpawnSize * 2))
					.decorated(Placement.DEPTH_AVERAGE.configured(
	...
	public static ConfiguredFeature<?, ?> ORE_OTHER_LEAD = newConfiguredFeature("ore_other_lead",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.LEAD.OTHER_ORE.get().defaultBlockState(), Configuration.lead_SpawnSize * 2))
					.decorated(Placement.DEPTH_AVERAGE.configured(
	...
	public static ConfiguredFeature<?, ?> ORE_OTHER_ZINC = newConfiguredFeature("ore_other_zinc",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.ZINC.OTHER_ORE.get().defaultBlockState(), Configuration.zinc_SpawnSize * 2))
					.decorated(Placement.DEPTH_AVERAGE.configured(
	...
	public static ConfiguredFeature<?, ?> ORE_OTHER_NICKEL = newConfiguredFeature("ore_other_nickel",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.NICKEL.OTHER_ORE.get().defaultBlockState(), Configuration.nickel_SpawnSize * 2))
					.decorated(Placement.DEPTH_AVERAGE.configured(
	...
	public static ConfiguredFeature<?, ?> ORE_OTHER_PLATINUM = newConfiguredFeature("ore_other_platinum",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.PLATINUM.OTHER_ORE.get().defaultBlockState(), Configuration.platinum_SpawnSize * 2))
					.decorated(Placement.DEPTH_AVERAGE.configured(
	...
	public static ConfiguredFeature<?, ?> ORE_OTHER_OSMIUM = newConfiguredFeature("ore_other_osmium",
			Feature.ORE
					.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHER_ORE_REPLACEABLES,
							BlockList.OSMIUM.OTHER_ORE.get().defaultBlockState(), Configuration.osmium_SpawnSize * 2))
					.decorated(Placement.DEPTH_AVERAGE.configured(
