...
public class ATOPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> ORE_RUBY = PlacementUtils.register("ore_ruby", ATOConfiguredFeature.ORE_RUBY,commonOrePlacement(Configuration.COMMON.ruby_SpawnCount.get(), HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(Configuration.COMMON.ruby_MinY.get()), VerticalAnchor.aboveBottom(Configuration.COMMON.ruby_MaxY.get()))));
    public static final Holder<PlacedFeature> ORE_SAPPHIRE = PlacementUtils.register("ore_sapphire", ATOConfiguredFeature.ORE_SAPPHIRE,commonOrePlacement(Configuration.COMMON.sapphire_SpawnCount.get(), HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(Configuration.COMMON.sapphire_MinY.get()), VerticalAnchor.aboveBottom(Configuration.COMMON.sapphire_MaxY.get()))));
    public static final Holder<PlacedFeature> ORE_PERIDOT = PlacementUtils.register("ore_peridot", ATOConfiguredFeature.ORE_PERIDOT,commonOrePlacement(Configuration.COMMON.peridot_SpawnCount.get(), HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(Configuration.COMMON.peridot_MinY.get()), VerticalAnchor.aboveBottom(Configuration.COMMON.peridot_MaxY.get()))));
